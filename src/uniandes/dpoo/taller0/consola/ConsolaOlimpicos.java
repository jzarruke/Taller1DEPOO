...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra el país que representa un atleta
	 */
	private void ejecutarPaisAtleta()
	{
		System.out.println("\n" + "Buscar el país al que representa un atleta" + "\n");

		String atleta = input("Por favor ingrese el nombre de un atleta");
		String nombrePais = calculadora.paisAtleta(atleta);
		System.out.println("El país representado por el atleta '" + atleta + "' es " + nombrePais);
	}
